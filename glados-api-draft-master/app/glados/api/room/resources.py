...
from glados.api.room.serializers import RoomResponseSerializer, RoomsRequestSerializer, RoomsCreationSerializer
...
class RoomsAPI(Resource):
    ...
    def post(self):
        ...
        request_serializer = RoomsCreationSerializer()
